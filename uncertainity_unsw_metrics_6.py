...
# Load rules
with open("forest_rules_unsw_6.json") as f:
    forest = json.load(f)

# Load UNSW dataset
df = pd.read_csv("unsw_processed_6f.csv")
...
plt.legend()
plt.tight_layout()
plt.savefig("images/unsw_uncertainty_metrics_6.png")
plt.close()

print("Saved unsw_uncertainty_metrics_6.png ✅")
